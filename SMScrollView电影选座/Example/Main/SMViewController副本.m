...
@property (strong, nonatomic) IBInspectable NSArray *arrayRowIndex; //座位号左边行号提示（用它则忽略
...
@property (retain, nonatomic) IBOutlet SMScrollView *myScrollView;
...
//    _myScrollView.contentSize = CGSizeMake((self.seatLeft + self.column * self.seatSize.width + self.seatRight) * 1.0,
//                                           (self.seatTop + self.row * self.seatSize.height + self.seatBottom) * 1.0);
...
//    self.contentView.frame = CGRectMake(0, 50, _myScrollView.frame.size.width, _myScrollView.frame.size.height);
    ...
    //计算并设置contentsize
//    self.myScrollView.contentSize = CGSizeMake((self.seatLeft + self.column * self.seatSize.width + self.seatRight) * _myScrollView.zoomScale,
//                                  (self.seatTop + self.row * self.seatSize.height + self.seatBottom) * _myScrollView.zoomScale);
    self.myScrollView.contentSize = CGSizeMake((self.seatLeft + self.column * self.seatSize.width + self.seatRight) * _myScrollView.zoomScale,
                                               (self.seatTop + self.row * self.seatSize.height + self.seatBottom) * _myScrollView.zoomScale);
...
//        self.rowIndexView.frame = CGRectMake(
//             (kRowIndexSpace + (self.rowIndexStick ? self.contentOffset.x : 0)) / self.zoomScale,
//             self.seatTop,
//             kRowIndexWith,
...
//        _contentView.frame = CGRectMake((kRowIndexSpace + (self.rowIndexStick ? _myScrollView.contentOffset.x : 0)) / _myScrollView.zoomScale,
//                                        self.seatTop,
